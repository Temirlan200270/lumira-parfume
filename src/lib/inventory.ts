...
export const inventory: InventoryItem[] = [
  ...
  { brand: 'Dolce&Gabbana', name: "D&G Anthology L'Imperatrice 3", gender: 'female' },
  ...
  { brand: 'Rabanne', name: 'Lady Million', gender: 'female' },
  ...
  { brand: 'Chanel', name: 'Allure Homme Sport', gender: 'male' },
  { brand: 'Chopard', name: 'Oud Malaki', gender: 'male' },
  { brand: 'Versace', name: 'Eros Parfum', gender: 'male' },
  { brand: 'Versace', name: 'Versace Man Eau Fraiche', gender: 'male' },
  { brand: 'Paco Rabanne', name: '1 Million', gender: 'male' },
  { brand: 'Rabanne', name: 'Invictus Victory', gender: 'male' },
  ...
  { brand: 'Bvlgari', name: 'Aqva Pour Homme Marine', gender: 'male' },
  { brand: 'Givenchy', name: 'Givenchy pour Homme Blue Label', gender: 'male' },
  { brand: 'Paco Rabanne', name: 'Invictus', gender: 'male' },
  { brand: 'Viktor&Rolf', name: 'Spicebomb', gender: 'male' },
  { brand: 'Dior', name: 'Sauvage Elixir', gender: 'male' },
  { brand: 'Dior', name: 'Sauvage', gender: 'male', hit: true },
