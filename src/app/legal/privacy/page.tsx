...
export const metadata: Metadata = {
  ...
  description: 'Как Lumira Parfume обрабатывает имя, телефон и город при заказе.',
}
    ...
    <main className="flex-1 bg-background">
      <div className="container-lumira section-y max-w-3xl">
        ...
        <LegalSection title="5. Кому передаём и где это происходит">
          ...
          <ul className="list-disc space-y-2 pl-5">
            <li>
              ...
              магазина размещён в регионе eu-central-1 (Франкфурт, Германия). Имя, телефон, город,
            ...
            <li>
              ...
              с магазином. В текст уходят имя, город, состав и сумма. Телефон покупателя в эту
            ...
            <li>
              ...
              уведомление: имя, телефон, город, состав и сумма, чтобы заказ не потерялся.
            </li>
          </ul>
          <p>
        ...
        <LegalSection title="6. Что остаётся в браузере">
          <p>
            В браузере (localStorage) хранятся корзина, избранное и тема оформления — чтобы список
            не сбрасывался при обновлении страницы. Счётчиков посещений, пикселей рекламы и
            аналитики на сайте нет.
          </p>
        </LegalSection>
